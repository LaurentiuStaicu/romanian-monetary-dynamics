...
def audit_loan_stock_to_debt_service_and_credit_risk_boundary(review,risk_review,boundary,readiness,feedback,model,baseline):
    ...
    if d.get("bank_credit_balance_sheet_next_structural_task")!="debt_service_and_credit_risk_to_credit_supply_capacity_boundary_review": errors.append("next bank-credit task changed")
...
def main():
    ...
    print(json.dumps({"status":"PASS","bridge_status":STATUS,"exact_integrated_equation_ready":False,"feedback_activation_authorized":False,"next_gate":"debt_service_and_credit_risk_to_credit_supply_capacity_boundary_review"},indent=2))
