...
def audit_risk_to_credit_supply_capacity_boundary(review,prudential_review,aggregate_review,boundary,readiness,feedback,model,baseline):
    ...
    if d.get("bank_credit_balance_sheet_next_structural_task")!="credit_supply_capacity_to_credit_flow_boundary_review": errors.append("next bank-credit task changed")
...
def main():
    ...
    print(json.dumps({"status":"PASS","bridge_status":STATUS,"capacity_scalar_selected":False,"exact_integrated_equation_ready":False,"feedback_activation_authorized":False,"next_gate":"credit_supply_capacity_to_credit_flow_boundary_review"},indent=2))
