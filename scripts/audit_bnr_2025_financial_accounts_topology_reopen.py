...
def main() -> None:
    ...
    print(json.dumps({
        ...
        "historical_trigger_effect":"NO_PROMOTION_AT_THIS_GATE",
        "current_reference_modes_ready":"10/10",
