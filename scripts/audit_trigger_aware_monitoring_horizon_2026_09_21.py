...
def audit_trigger_horizon_2026_09_21():
    ...
    for key in (
        ...
        "model_selection_authorized","target_family_switch_authorized","holdout_opening_authorized",
        "system_dynamics_activation_authorized","behavioural_closure_authorized","reference_mode_promotion_authorized",
    ):
