...
class ReferenceModeRecoveryTerminalAssessmentTests(unittest.TestCase):
    ...
    def test_only_sectoral_financial_positions_remains_blocked(self):
        ...
        self.assertEqual(mode["reference_mode_recovery_stage_status"], "SUCCESSOR_REFERENCE_MODE_SET_COMPLETE_10_OF_10")
        self.assertEqual(
    ...
    def test_baseline_manifest_registers_successor_reference_stage(self):
        r = self.manifest["canonical_state"]["reference_modes"]
        self.assertEqual(r["recovery_stage_status"], "SUCCESSOR_REFERENCE_MODE_SET_COMPLETE_10_OF_10")
