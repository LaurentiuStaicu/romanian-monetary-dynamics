...
class RMDReadmeDesignContractTests(unittest.TestCase):
    ...
    def test_public_readme_exposes_finalized_v030_release_state(self) -> None:
        basis = self.release["versioning_basis"]
        self.assertEqual(basis["current_public_release"]["version"], "0.3.0")
        ...
        self.assertIn("**v0.4.0**", self.public)
        self.assertIn("**v0.3.1**", self.public)
