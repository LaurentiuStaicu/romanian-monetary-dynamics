...
class ReleaseVersioningContractTests(unittest.TestCase):
    ...
    def test_repository_version_is_atomic_across_metadata(self):
    ...
    def test_current_public_release_is_v030_after_publication(self):
        ...
        self.assertEqual(release["release_target_commit"],"33c11b7e10e7e837097da5b34a9251c7bedb3f2c")
        self.assertEqual(release["release_id"],393215575)
    ...
    def test_v030_release_preparation_is_finalized(self):
        ...
        self.assertEqual(prep["exact_release_commit"],"33c11b7e10e7e837097da5b34a9251c7bedb3f2c")
        self.assertEqual(prep["release_notes"],"releases/v0.3.0.md")
        self.assertEqual(prep["publication_record"],"model/registries/v0_3_0_release_publication_record_2026_09_21.json")
        self.assertEqual(basis["next_public_release_candidate"],"0.4.0")
        self.assertTrue(basis["unreleased_changes_present"])
        self.assertFalse(basis["version_bump_required_now"])
    ...
    def test_model_contract_registers_finalized_v030_state(self):
        ...
        self.assertEqual(g["last_public_release_commit"],"33c11b7e10e7e837097da5b34a9251c7bedb3f2c")
        self.assertEqual(g["last_public_release_tag"],"v0.3.0")
        self.assertEqual(g["release_publication_record"],"model/registries/v0_3_0_release_publication_record_2026_09_21.json")
