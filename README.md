...
| **Observed evidence & reference modes** | Supplies behaviour-over-time targets and official empirical evidence | 10 of 10 required reference modes are ready at the aggregate observation boundary |
...
- all ten required reference modes observed at the aggregate behaviour-over-time boundary;
