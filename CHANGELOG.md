...
- reviewed the government-interest-cost to financing-need boundary: Eurostat D41 accrual interest expenditure and the Ministry principal-refinancing reference remain distinct components rather than a canonical gross-financing-needs identity; the positive qualitative link is retained, a fifth empirical bridge is added to the closure gate, and no cross-boundary sum, estimation, reference-mode promotion or feedback activation is authorized;
- reviewed the sovereign-yield to government-interest-cost boundary: the ECB 10-year RON target remains a long-term market-condition observable, while the Ministry portfolio average rate and Eurostat D41 interest expenditure remain distinct observed targets; no contemporaneous one-to-one yield/cost mapping, repricing parameter, scalar delay, equation or feedback activation is authorized;
